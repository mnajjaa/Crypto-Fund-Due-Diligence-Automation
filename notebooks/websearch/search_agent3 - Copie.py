...
### Answer Style:"""
    ...
    try:
        response = ollama.chat(
            ...
            stream=False  # 🔥 No streaming, we want full response
        )
...
'''
        ...
        assistant_convo.append({'role': 'user', 'content': final_prompt})  # ✅ Correct indentation (inside while)
        stream_assistant_response()  # ✅ Correct placement (inside while)
